...
public class Step7 implements TennisGame {
    ...
    public Step7(String namePlayer1, String namePlayer2) {
    ...
    public String getScore() {
        ...
        if (player1.getPoints() < 4 && player2.getPoints() < 4 && !(gameStatusIsDeuce(player1.getPoints(), player2.getPoints()))) {
            return (player1.getPoints() == player2.getPoints()) ? player1.getScore() + "-All" : player1.getScore() + "-" + player2.getScore();
        }
        if (gameStatusIsDeuce(player1.getPoints(), player2.getPoints()))
            return "Deuce";
        leadingPlayer = getLeadingPlayer(player1, player2);
        if (gameIsWon(player1.getPoints(), player2.getPoints()))
    ...
    private boolean gameStatusIsDeuce (int pointsPlayer1, int pointsPlayer2){
        return (pointsPlayer1==pointsPlayer2) && (pointsPlayer1>2);
    }

    private boolean gameIsWon(int pointsPlayer1, int pointsPlayer2){
